        ...
        <div class="-my-2">
          <div class="relative box-content h-80 overflow-x-auto py-2 xl:overflow-visible">
            <div class="min-w-screen-xl absolute flex space-x-8 px-4 sm:px-6 lg:px-8 xl:relative xl:grid xl:grid-cols-5 xl:gap-x-8 xl:space-x-0 xl:px-0">
              ...
              <a href="/categories/{{ $child->slug }}" class="relative flex h-80 w-56 flex-col overflow-hidden rounded-lg p-6 hover:opacity-75 xl:w-auto">
                ...
                <span class="relative mt-auto text-center text-xl font-bold text-white">{{ $child->title }}</span>
              </a>
              @endforeach
            </div>
          </div>
        ...
        <div class="grid grid-cols-2 gap-8 xl:col-span-2">
          ...
          <div class="space-y-12 md:grid md:grid-cols-2 md:gap-8 md:space-y-0">
            <div>
              ...
              <ul role="list" class="mt-6 space-y-6">
                <li class="text-sm">
                  <a href="/tenant" class="text-gray-300 hover:text-white">Manage Tenant</a>
                </li>
